...
export type ProjectCustomDomainTargetType = typeof ProjectCustomDomainTargetType[keyof typeof ProjectCustomDomainTargetType];


export const ProjectCustomDomainTargetType = {
  frontend: 'frontend',
  function: 'function',
} as const;
