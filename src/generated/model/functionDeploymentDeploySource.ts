 ...
 */
export type FunctionDeploymentDeploySource = typeof FunctionDeploymentDeploySource[keyof typeof FunctionDeploymentDeploySource];


export const FunctionDeploymentDeploySource = {
  git: 'git',
  cli: 'cli',
  web: 'web',
  api: 'api',
