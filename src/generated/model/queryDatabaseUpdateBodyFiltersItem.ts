 ...
 */
import type { QueryDatabaseUpdateBodyFiltersItemOperator } from './queryDatabaseUpdateBodyFiltersItemOperator';

export type QueryDatabaseUpdateBodyFiltersItem = {
  column: string;
  operator: QueryDatabaseUpdateBodyFiltersItemOperator;
