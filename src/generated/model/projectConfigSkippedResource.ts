 ...
 */
import type { ProjectConfigSkippedResourceType } from './projectConfigSkippedResourceType';

export interface ProjectConfigSkippedResource {
  type: ProjectConfigSkippedResourceType;
  name: string;
  reason: string;
}
