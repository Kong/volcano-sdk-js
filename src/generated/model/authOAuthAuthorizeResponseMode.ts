...
export type AuthOAuthAuthorizeResponseMode = typeof AuthOAuthAuthorizeResponseMode[keyof typeof AuthOAuthAuthorizeResponseMode];


export const AuthOAuthAuthorizeResponseMode = {
  code: 'code',
} as const;
