...
export type ProjectDeploymentOperation = typeof ProjectDeploymentOperation[keyof typeof ProjectDeploymentOperation];


export const ProjectDeploymentOperation = {
  deploy: 'deploy',
  redeploy: 'redeploy',
  update: 'update',
  delete: 'delete',
