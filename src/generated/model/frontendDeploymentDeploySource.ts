 ...
 */
export type FrontendDeploymentDeploySource = typeof FrontendDeploymentDeploySource[keyof typeof FrontendDeploymentDeploySource];


export const FrontendDeploymentDeploySource = {
  git: 'git',
  cli: 'cli',
  web: 'web',
  api: 'api',
