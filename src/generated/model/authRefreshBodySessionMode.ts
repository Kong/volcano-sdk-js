...
export type AuthRefreshBodySessionMode = typeof AuthRefreshBodySessionMode[keyof typeof AuthRefreshBodySessionMode];


export const AuthRefreshBodySessionMode = {
  cookie: 'cookie',
} as const;
