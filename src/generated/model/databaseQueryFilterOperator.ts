 ...
 * - in: IN array
 */
export type DatabaseQueryFilterOperator = typeof DatabaseQueryFilterOperator[keyof typeof DatabaseQueryFilterOperator];


export const DatabaseQueryFilterOperator = {
  eq: 'eq',
  neq: 'neq',
  gt: 'gt',
  gte: 'gte',
