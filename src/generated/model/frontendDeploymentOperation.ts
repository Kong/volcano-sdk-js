...
export type FrontendDeploymentOperation = typeof FrontendDeploymentOperation[keyof typeof FrontendDeploymentOperation];


export const FrontendDeploymentOperation = {
  deploy: 'deploy',
  redeploy: 'redeploy',
  delete: 'delete',
} as const;
