...
export type ProjectConfigApplyResultEntryAction = typeof ProjectConfigApplyResultEntryAction[keyof typeof ProjectConfigApplyResultEntryAction];


export const ProjectConfigApplyResultEntryAction = {
  created: 'created',
  updated: 'updated',
  deleted: 'deleted',
  unchanged: 'unchanged',
