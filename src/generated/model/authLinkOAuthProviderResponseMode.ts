...
export type AuthLinkOAuthProviderResponseMode = typeof AuthLinkOAuthProviderResponseMode[keyof typeof AuthLinkOAuthProviderResponseMode];


export const AuthLinkOAuthProviderResponseMode = {
  code: 'code',
} as const;
