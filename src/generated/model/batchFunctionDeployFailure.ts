 ...
 */
import type { BatchFunctionDeployFailureOperation } from './batchFunctionDeployFailureOperation';

export interface BatchFunctionDeployFailure {
  name: string;
  function_id?: string;
  operation?: BatchFunctionDeployFailureOperation;
  error: string;
}
