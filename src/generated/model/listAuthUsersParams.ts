...
import type { ListAuthUsersStatus } from './listAuthUsersStatus';
...
/**
 * Filter by effective status. `banned` returns only currently-banned users; an expired temporary ban lists as `active`.
 */
status?: ListAuthUsersStatus;
};
