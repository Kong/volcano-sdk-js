...
export type ProjectConfigSkippedResourceType = typeof ProjectConfigSkippedResourceType[keyof typeof ProjectConfigSkippedResourceType];


export const ProjectConfigSkippedResourceType = {
  function: 'function',
  frontend: 'frontend',
  database: 'database',
  bucket: 'bucket',
