 ...
 */
import type { QueryDatabaseDeleteBodyFiltersItem } from './queryDatabaseDeleteBodyFiltersItem';

export type QueryDatabaseDeleteBody = {
  /** Table name */
  table: string;
  /**
     ...
     * @minItems 1
     */
  filters: QueryDatabaseDeleteBodyFiltersItem[];
};
