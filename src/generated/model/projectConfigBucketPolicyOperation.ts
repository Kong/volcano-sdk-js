...
export type ProjectConfigBucketPolicyOperation = typeof ProjectConfigBucketPolicyOperation[keyof typeof ProjectConfigBucketPolicyOperation];


export const ProjectConfigBucketPolicyOperation = {
  SELECT: 'SELECT',
  INSERT: 'INSERT',
  UPDATE: 'UPDATE',
  DELETE: 'DELETE',
