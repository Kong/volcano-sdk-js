...
export type ProjectDeploymentResourceType = typeof ProjectDeploymentResourceType[keyof typeof ProjectDeploymentResourceType];


export const ProjectDeploymentResourceType = {
  function: 'function',
  frontend: 'frontend',
} as const;
