...
export type DeploymentProgressCurrentPhase = typeof DeploymentProgressCurrentPhase[keyof typeof DeploymentProgressCurrentPhase];


export const DeploymentProgressCurrentPhase = {
  queue: 'queue',
  checkout: 'checkout',
  build: 'build',
  image: 'image',
