...
export type FrontendCustomDomainResponseTlsMode = typeof FrontendCustomDomainResponseTlsMode[keyof typeof FrontendCustomDomainResponseTlsMode];


export const FrontendCustomDomainResponseTlsMode = {
  managed: 'managed',
  byoc: 'byoc',
} as const;
