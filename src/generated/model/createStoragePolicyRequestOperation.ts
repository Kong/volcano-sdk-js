 ...
 */
export type CreateStoragePolicyRequestOperation = typeof CreateStoragePolicyRequestOperation[keyof typeof CreateStoragePolicyRequestOperation];


export const CreateStoragePolicyRequestOperation = {
  SELECT: 'SELECT',
  INSERT: 'INSERT',
  UPDATE: 'UPDATE',
  DELETE: 'DELETE',
