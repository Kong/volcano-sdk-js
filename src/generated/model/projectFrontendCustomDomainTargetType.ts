...
export type ProjectFrontendCustomDomainTargetType = typeof ProjectFrontendCustomDomainTargetType[keyof typeof ProjectFrontendCustomDomainTargetType];


export const ProjectFrontendCustomDomainTargetType = {
  frontend: 'frontend',
} as const;
