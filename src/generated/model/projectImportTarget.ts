...
export type ProjectImportTarget = typeof ProjectImportTarget[keyof typeof ProjectImportTarget];


export const ProjectImportTarget = {
  ProjectImportTargetProduction: 'production',
} as const;
