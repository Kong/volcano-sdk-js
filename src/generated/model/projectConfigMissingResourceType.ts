...
export type ProjectConfigMissingResourceType = typeof ProjectConfigMissingResourceType[keyof typeof ProjectConfigMissingResourceType];


export const ProjectConfigMissingResourceType = {
  function: 'function',
  frontend: 'frontend',
  database: 'database',
  bucket: 'bucket',
