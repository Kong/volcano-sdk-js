...
export type SandboxSessionDesiredState = typeof SandboxSessionDesiredState[keyof typeof SandboxSessionDesiredState];


export const SandboxSessionDesiredState = {
  running: 'running',
  suspended: 'suspended',
