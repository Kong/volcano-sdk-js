 ...
 */
import type { ProjectMetricsResult } from './projectMetricsResult';
import type { ProjectMetricsWindow } from './projectMetricsWindow';

export interface ProjectMetricsQueryResponse {
  observed_at: string;
