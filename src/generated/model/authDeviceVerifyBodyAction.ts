...
export type AuthDeviceVerifyBodyAction = typeof AuthDeviceVerifyBodyAction[keyof typeof AuthDeviceVerifyBodyAction];


export const AuthDeviceVerifyBodyAction = {
  approve: 'approve',
  deny: 'deny',
} as const;
