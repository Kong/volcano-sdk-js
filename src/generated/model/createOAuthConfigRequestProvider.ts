...
export type CreateOAuthConfigRequestProvider = typeof CreateOAuthConfigRequestProvider[keyof typeof CreateOAuthConfigRequestProvider];


export const CreateOAuthConfigRequestProvider = {
  google: 'google',
  github: 'github',
  microsoft: 'microsoft',
  apple: 'apple',
