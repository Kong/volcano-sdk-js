 ...
 */
import type { ProjectConfigSchedulerPayload } from './projectConfigSchedulerPayload';

export interface ProjectConfigScheduler {
  /**
     * @minLength 1
     * @maxLength 200
     */
  ...
  cron: string;
  enabled?: boolean;
  payload?: ProjectConfigSchedulerPayload;
}
