...
export type GetDatabaseStatsGranularity = typeof GetDatabaseStatsGranularity[keyof typeof GetDatabaseStatsGranularity];


export const GetDatabaseStatsGranularity = {
  hourly: 'hourly',
  daily: 'daily',
  monthly: 'monthly',
} as const;
