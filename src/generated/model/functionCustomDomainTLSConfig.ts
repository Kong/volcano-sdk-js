 ...
 */
import type { FunctionCustomDomainTLSConfigMode } from './functionCustomDomainTLSConfigMode';

export interface FunctionCustomDomainTLSConfig {
  mode: FunctionCustomDomainTLSConfigMode;
