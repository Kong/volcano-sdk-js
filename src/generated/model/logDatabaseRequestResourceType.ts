 ...
 */
export type LogDatabaseRequestResourceType = typeof LogDatabaseRequestResourceType[keyof typeof LogDatabaseRequestResourceType];


export const LogDatabaseRequestResourceType = {
  database: 'database',
} as const;
