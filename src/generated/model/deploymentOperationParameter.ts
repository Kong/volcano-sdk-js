...
export type DeploymentOperationParameter = typeof DeploymentOperationParameter[keyof typeof DeploymentOperationParameter];


export const DeploymentOperationParameter = {
  deploy: 'deploy',
  redeploy: 'redeploy',
  update: 'update',
  delete: 'delete',
