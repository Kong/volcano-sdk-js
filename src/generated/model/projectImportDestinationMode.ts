...
export type ProjectImportDestinationMode = typeof ProjectImportDestinationMode[keyof typeof ProjectImportDestinationMode];


export const ProjectImportDestinationMode = {
  ProjectImportDestinationCreate: 'create',
} as const;
