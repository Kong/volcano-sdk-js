 ...
 */
import type { ProjectCustomDomainTargetType } from './projectCustomDomainTargetType';

export interface ProjectCustomDomainTarget {
  type: ProjectCustomDomainTargetType;
  id: string;
  name: string;
}
