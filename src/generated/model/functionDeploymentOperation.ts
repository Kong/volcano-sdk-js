...
export type FunctionDeploymentOperation = typeof FunctionDeploymentOperation[keyof typeof FunctionDeploymentOperation];


export const FunctionDeploymentOperation = {
  deploy: 'deploy',
  update: 'update',
  delete: 'delete',
} as const;
