 ...
 */
import type { QueryDatabaseDeleteBodyFiltersItemOperator } from './queryDatabaseDeleteBodyFiltersItemOperator';

export type QueryDatabaseDeleteBodyFiltersItem = {
  column: string;
  operator: QueryDatabaseDeleteBodyFiltersItemOperator;
