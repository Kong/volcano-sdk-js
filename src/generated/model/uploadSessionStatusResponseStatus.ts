 ...
 */
export type UploadSessionStatusResponseStatus = typeof UploadSessionStatusResponseStatus[keyof typeof UploadSessionStatusResponseStatus];


export const UploadSessionStatusResponseStatus = {
  pending: 'pending',
  uploading: 'uploading',
