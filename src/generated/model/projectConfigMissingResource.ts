 ...
 */
import type { ProjectConfigMissingResourceType } from './projectConfigMissingResourceType';

export interface ProjectConfigMissingResource {
  type: ProjectConfigMissingResourceType;
  name: string;
}
