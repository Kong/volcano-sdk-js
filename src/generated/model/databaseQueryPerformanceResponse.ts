 ...
 */
import type { DatabaseQueryPerformanceItem } from './databaseQueryPerformanceItem';

export interface DatabaseQueryPerformanceResponse {
  data: DatabaseQueryPerformanceItem[];
}
