...
export type FunctionCustomDomainTLSConfigMode = typeof FunctionCustomDomainTLSConfigMode[keyof typeof FunctionCustomDomainTLSConfigMode];


export const FunctionCustomDomainTLSConfigMode = {
  byoc: 'byoc',
} as const;
