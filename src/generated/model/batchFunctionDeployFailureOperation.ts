...
export type BatchFunctionDeployFailureOperation = typeof BatchFunctionDeployFailureOperation[keyof typeof BatchFunctionDeployFailureOperation];


export const BatchFunctionDeployFailureOperation = {
  deploy: 'deploy',
  update: 'update',
} as const;
