...
export type DeploymentResourceTypeParameter = typeof DeploymentResourceTypeParameter[keyof typeof DeploymentResourceTypeParameter];


export const DeploymentResourceTypeParameter = {
  function: 'function',
  frontend: 'frontend',
} as const;
