...
export type FunctionCustomDomainResponseTlsMode = typeof FunctionCustomDomainResponseTlsMode[keyof typeof FunctionCustomDomainResponseTlsMode];


export const FunctionCustomDomainResponseTlsMode = {
  byoc: 'byoc',
} as const;
