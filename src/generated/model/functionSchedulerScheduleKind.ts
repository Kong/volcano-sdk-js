...
export type FunctionSchedulerScheduleKind = typeof FunctionSchedulerScheduleKind[keyof typeof FunctionSchedulerScheduleKind];


export const FunctionSchedulerScheduleKind = {
  cron: 'cron',
} as const;
