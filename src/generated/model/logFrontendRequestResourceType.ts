 ...
 */
export type LogFrontendRequestResourceType = typeof LogFrontendRequestResourceType[keyof typeof LogFrontendRequestResourceType];


export const LogFrontendRequestResourceType = {
  frontend: 'frontend',
} as const;
