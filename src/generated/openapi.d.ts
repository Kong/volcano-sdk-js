...
export interface paths {
  ...
  '/projects/{id}/logo': {
     ...
     * @description Returns the raw logo image stored in the project's S3 folder. This
     ...
     * @description Uploads an image as the project's logo, storing it in the project's S3
     ...
     * @description Deletes the project logo from the project's S3 folder and clears its
  ...
  '/projects/{id}/databases/{databaseName}': {
    ...
    /**
     * Delete a database
     * @description Deletes a database and its backing Neon project. When the Neon project is
  ...
  '/databases/regions': {
     ...
     * @description Returns the AWS-backed Neon regions enabled for this platform environment.
  ...
  '/functions/regions': {
     ...
     * @description Returns the configured AWS regions where functions can be deployed, each annotated
  ...
  '/projects/{id}/auth/hosted-pages/{pageType}': {
     ...
     * @description Returns current saved HTML/CSS for the page type. If no custom page exists yet, returns the default template for that page type.
     */
...
export interface components {
  schemas: {
    ...
    AuthHostedPageResponse: {
      page?: components['schemas']['AuthHostedPage'];
    };
    /**
    ...
    CreateDatabaseRequest: {
      ...
      name: string;
      /**
       * @description AWS region for database hosting
    ...
    Database: {
      ...
      /**
       * @description AWS region where database is hosted
       * @example aws-us-east-1
       */
      region?: string;
      /**
    ...
    FunctionRegion: {
      /**
       * @description AWS region identifier accepted by function APIs.
       * @example us-east-1
       */
      code: string;
      /**
    ...
    ProjectConfigDatabase: {
      name: string;
      /** @description Deployed region (aws- prefixed, e.g. aws-us-east-1). Asserted, never written. */
      region: string;
      /**
    ...
    ProjectConfigProject: {
      ...
      all_regions?: boolean;
      /** @description Region subset (bare AWS names). Requires `all_regions=false`. */
      selected_regions?: string[];
    };
    ...
    /** @enum {string} */
    ProjectMetricsDataStatus: 'complete' | 'no_data';
    ...
    StorageObject: {
      ...
      mime_type: string;
      /** @description S3 ETag for cache validation */
      etag?: string;
      /**
    ...
    LogRequestResource:
      | components['schemas']['LogFunctionRequestResource']
      | components['schemas']['LogFrontendRequestResource']
      | components['schemas']['LogDatabaseRequestResource'];
  ...
  responses: {
    /**
     * @description The platform user exceeded their monthly bandwidth cap (aggregate
    ...
    /**
     * @description The query was rejected by a monthly usage cap: either the platform user's
...
export interface operations {
  ...
  deleteDatabase: {
    ...
    responses: {
      /**
       * @description Deletion accepted and in progress. The Neon project could not be
      ...
      /** @description Database deleted (Neon project removed synchronously) */
      204: {
        headers: {
          [name: string]: unknown;
        };
    ...
    responses: {
      ...
      200: {
        ...
        content: {
           ...
           */
          'application/json': {
            /** @description Result rows of the probe query */
            data?: {
              [key: string]: unknown;
            }[];
    ...
    responses: {
      ...
      200: {
        ...
        content: {
           ...
           */
          'application/json': {
            /** @description Array of result rows (automatically filtered by RLS) */
            data?: {
              [key: string]: unknown;
            }[];
            /** @description Number of rows returned */
    ...
    responses: {
      ...
      200: {
        ...
        content: {
           ...
           */
          'application/json': {
            /** @description Inserted row(s) with all columns */
            data?: {
              [key: string]: unknown;
            }[];
            count?: number;
      ...
      /** @description Access denied - database does not belong to this project */
      403: {
        headers: {
          [name: string]: unknown;
        };
    ...
    requestBody: {
      content: {
        'application/json': {
          ...
          /**
           * @description WHERE conditions for which rows to update. At least one filter
    ...
    responses: {
      ...
      200: {
        ...
        content: {
           ...
           */
          'application/json': {
            /** @description Updated row(s). Empty if RLS blocked the update. */
            data?: {
              [key: string]: unknown;
            }[];
            count?: number;
    ...
    responses: {
      ...
      200: {
        ...
        content: {
           ...
           */
          'application/json': {
            /** @description Deleted row(s). Empty if RLS blocked the delete. */
            data?: {
              [key: string]: unknown;
            }[];
            count?: number;
  ...
  listDatabaseRegions: {
    ...
    requestBody?: never;
    responses: {
      /** @description List of platform-supported AWS-backed regions */
      200: {
        headers: {
          [name: string]: unknown;
        };
  ...
  authSignup: {
    ...
    responses: {
      ...
      /** @description Forbidden - Signups disabled or anon key lacks signup permission */
      403: {
        headers: {
          [name: string]: unknown;
        };
  ...
  authSignin: {
    ...
    responses: {
      ...
      /** @description Forbidden - Anon key lacks signin permission */
      403: {
        headers: {
          [name: string]: unknown;
        };
  ...
  authPlatformExchange: {
    ...
    responses: {
      ...
      /** @description Exchange not allowed for this session/client/project */
      403: {
        headers: {
          [name: string]: unknown;
        };
  ...
  uploadStorageObject: {
    ...
    responses: {
      ...
      201: {
        ...
        content: {
          'application/json':
            | components['schemas']['StorageObject']
