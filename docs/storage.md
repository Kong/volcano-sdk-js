...
Authenticated storage requests refresh the current session after an HTTP 401
and retry the request once. Upload retries preserve the original file bytes.
