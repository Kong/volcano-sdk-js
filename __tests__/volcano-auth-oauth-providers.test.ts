...
describe('VolcanoAuth OAuth provider operations', () => {
  describe('OAuth', () => {
    ...
    it('should have convenience methods for all providers', () => {
      expect(providerMethod('signInWithGoogle')).toContain('/oauth/google/');
      expect(providerMethod('signInWithGitHub')).toContain('/oauth/github/');
      expect(providerMethod('signInWithMicrosoft')).toContain('/oauth/microsoft/');
      expect(providerMethod('signInWithApple')).toContain('/oauth/apple/');
    });
